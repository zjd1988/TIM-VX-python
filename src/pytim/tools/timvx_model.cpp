...
namespace TimVX
{
    ...
    int TimVXModel::initModelInputTensors()
    {
        ...
        for (int i = 0; i < m_input_attrs.size(); i++)
        {
            ...
            else
            {
                ...
                tensor_data.reset(new ModelTensorData(tensor_shape, tensor_type, tensor_format));
            }
    ...
    int TimVXModel::modelInfer()
    {
        ...
        for (int i = 0; i < n_inputs; i++)
        {
            ...
            model_inputs[i].pass_through = m_cmd_opt.pass_through;
        }
        ...
        for (int i = 0; i < n_outputs; i++)
        {
            ...
            model_outputs[i].is_prealloc = true;
            model_outputs[i].buf = tensor->tensorData();
            model_outputs[i].want_float = m_cmd_opt.want_float;
        }
